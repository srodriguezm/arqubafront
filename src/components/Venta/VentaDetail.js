...
class VentaDetail extends Component{
  constructor(props){
    super(props);
    this.state={
      id: 1,
  ...
  componentDidMount() {
        var id=this.props.match.params.idVenta;
            console.log(id);
            axios.get('https://arquba-backend.herokuapp.com/venta/'+id)
                .then((response) => {
              ...
              <div className="bg-white property-body border-bottom border-left border-right">
                <div className="row mb-5">
                  <div className="col-md-6">
                    <strong className="text-success h1 mb-3">${this.state.valor}</strong>
                  </div>
                  <div className="col-md-6">
                ...
                <div className="row mb-5">
                  ...
                  <div className="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                    <span className="d-inline-block text-black mb-0 caption-text">Zona</span>
                    <strong className="d-block">{this.state.sector}</strong>
                  </div>
                  <div className="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                ...
                <h2 className="h4 text-black">Detalles de la pripiedad en Venta</h2>
